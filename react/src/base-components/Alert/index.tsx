import { forwardRef, Fragment, ReactElement, ReactNode, useState } from "react";
...
// Define a generic type for the Alert component
type AlertComponent<C extends React.ElementType> = React.ForwardRefExoticComponent<
  PolymorphicComponentPropWithRef<C, AlertProps<C>>
>;

// Define the AlertProps type
type AlertProps<C extends React.ElementType> = PolymorphicComponentPropWithRef<
  C,
  {
    children:
      | ReactNode
      | ((props: { dismiss: () => void }) => ReactElement);
    dismissible?: boolean;
    variant?: Variant;
    onShow?: () => void;
    onShown?: () => void;
