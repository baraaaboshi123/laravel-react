import { forwardRef, ReactNode, ReactElement, JSXElementConstructor, RefAttributes } from "react";
...
// Define a generic type for the Button component
type ButtonComponent<C extends React.ElementType> = React.ForwardRefExoticComponent<
  PolymorphicComponentPropWithRef<C, ButtonProps<C>>
>;
...
) as ButtonComponent<"button">; // Specify the default type for C
